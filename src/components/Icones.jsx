// Ícones SVG inline simples (sem emoji como ícone).
...
export const IcoGrade = (p) => (
  <svg {...base} {...p}>
    <rect x="3" y="3" width="18" height="18" rx="2" />
    <path d="M3 9h18M3 15h18M9 3v18M15 3v18" />
  </svg>
)
export const IcoCurso = (p) => (
  <svg {...base} {...p}>
    <path d="M22 10 12 5 2 10l10 5z" />
    <path d="M6 12v5c0 1.5 3 3 6 3s6-1.5 6-3v-5" />
  </svg>
)
export const IcoChama = (p) => (
  <svg {...base} {...p}>
    <path d="M12 3c1 3 4 4.5 4 8.5a4 4 0 0 1-8 0c0-1.5.5-2.5 1.2-3.5.3 1.2 1 1.8 1.8 2C10.5 7.5 11 5 12 3z" />
  </svg>
)
export const IcoSeta = (p) => (
  <svg {...base} {...p}>
